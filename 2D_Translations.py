...
transformationInX = int(input("Enter the transformation in x: "))
transformationInY = int(input("Enter the transformation in y: "))
transformationVector.append((1, 0, transformationInX))
transformationVector.append((0, 1, transformationInY))
