...
rotationAngleDegrees = int(input("Enter the rotation angle anticlockwise about the origin: "))
rotationAngleRadian = (math.pi / 180) * rotationAngleDegrees
transformationVector.append((math.cos(rotationAngleRadian), -math.sin(rotationAngleRadian), 0))
transformationVector.append((math.sin(rotationAngleRadian), math.cos(rotationAngleRadian), 0))
